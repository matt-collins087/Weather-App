  ...
  return (
    <div className="current-weather-container">
      <div className="current-weather-temp">
        ...
        <h4>{Math.round(daily.wind_speed)}mph<img className="wind-image" src={`/Users/mattix/Desktop/HRATX/MVP/Weather-App/client/dist/images/wind.png`}></img></h4>
      </div>

      <div className="current-weather-image">
        <img src={`/Users/mattix/Desktop/HRATX/MVP/Weather-App/client/dist/images/${current.weather[0].main}.png`}></img>
